...
Вы можете воспользоваться публичной и бесплатной версией опубликованной на [Vercel](https://torapi.vercel.app/api/provider/list), или развернуть его самостоятельно. Для работы с API не нужен токен доступа и авторизация в трекерах, также вам не потребуется VPN, eсли вы используете верисю, опубликованную на Vercel. Спецификация **OpenAPI** доступна на официальном сайте [Swagger Hub](https://app.swaggerhub.com/apis-docs/Lifailon/TorAPI).
...
| Имя провайдера                      | Зеркала | Регистрация  |  Фильтрация для поиска         | Поиск по ID  | RSS      |
| -                                   | -       | -            |  -                             | -            | -        |
| [RuTracker](https://rutracker.org)  | 3       | Yes*         |  Категория                     | Yes          | Native   |
| [Kinozal](https://kinozal.tv)       | 3       | Yes*         |  Категория, год выхода, формат | Yes          | Native   |
