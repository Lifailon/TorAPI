...
Также доступны параметризированные тесты через [GitHub Actions](/.github/workflows/ci-postman-tests.yml) с использованием [Postman](/postman-tests.json) и [Newman](https://github.com/postmanlabs/newman) для формирования отчета в формате `junit` или `html`.
